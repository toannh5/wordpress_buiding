    ...
    public function demo_installer() {
        ...
        <form method="post">
            ...
            <select name="ot_demo_file" style="width: 100px;">
              ...
              <!--<option value="primary">Primary</option> --> <!-- Davis change -->
              <option value="archiv1">Archi Dark</option> <!-- Davis change -->
              <option value="archiv2">Archi Light</option> <!-- Davis change -->        
            </select>
            <br/><br/>
